<script lang="ts">
	// Backlinks panel — pages that link to the current one (Quartz Backlinks
	// parity), styled as cca-aesthetic cards (1px border-border, rounded,
	// surface hover, accent on hover) to match DocPager.
